...
namespace 超市管理系统
{
    public partial class shouhuo : Form
    {
        ...
        public shouhuo(string user)
        {
            InitializeComponent();
            this.user = user;
        }

        private void shouhuo_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand SCD = new SqlCommand("select  Code,Cname,Cunit,Cpricrout,Cnum1 ,Cprice from product where Cnum1!=0", conn);
