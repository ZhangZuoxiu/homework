                ...
                <div id="bs_bannercenter">
                    <div id="bs_bannerleft">
                       ...
                       <div></div>
                            ...
                            <div></div>
                            <br>
                            <div align='center'><font size="10" color="white">59store零食店</font>
                            </div>
                            <div class="bs_nav">
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="no" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/Main.html" >
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="main2.jsp" >
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="fbox">
                <div id="bs_footcenter">
                    <div id="bs_footleft">
                        <div id="bs_footright">
                            59store零食店——开在宿舍的零食店
                            <td align='right'><input type="button" value='退出系统'onclick="window.location.href='login.jsp'"></td>
                        </div>
                    </div>
                </div>
            </div>
