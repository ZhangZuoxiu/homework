...
.danyuange
{
     ...
     <s:else>
      ...
      <tr align="center">
        <td height="31" colspan="4"> 
        	<input type="button" onclick="window.location='needXXSHTG?WJID=<s:property value="needBack.WJID"/>'" value="通过"/>
        	<input type="button" onclick="window.location='needXXSHBTG?WJID=<s:property value="needBack.WJID"/>'" value="不通过"/>
        </td>
      </tr>
    </table>
  </form>
 ...
 <script type="text/javascript" src="JS1/NeedModeAuditPage.js" charset="gbk"></script> 
  </body>
</html>
