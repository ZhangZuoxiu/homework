...
<body>
<h1 style="color:#4682B4 ">欢迎来到个人清洁区</h1>
<jsp:useBean id="db" class="javaBean.DBean" scope="page" />
<h3 style="color:#4682B4 ">个人清洁区1</h3>
	<%
		String sql1="select * from commodity where place= '个人清洁1'";
...
<h3 style="color:#4682B4 ">个人清洁区2</h3>
	<%
		String sql2="select * from commodity where place= '个人清洁2'";
