...
<body>
<h1 style="color:#4682B4 ">欢迎来到蔬果区</h1>
<jsp:useBean id="db" class="javaBean.DBean" scope="page" />
<h3 style="color:#4682B4 ">蔬菜区</h3>
	<%
		String sql1="select * from commodity where place= '蔬菜区1'";
...
<h3 style="color:#4682B4 ">水果区</h3>
	<%
		String sql2="select * from commodity where place= '蔬菜区2'";
